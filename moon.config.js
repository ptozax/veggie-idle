...
const CONFIG = {
  ...
  theme: {
    ...
    // ไอคอนแทนสวนตอน "ซ่อนสวน" (ฐานย่อบนพื้นจันทรา วางแบบของตกแต่ง)
    miniIcon: {
      em:   '🛰️',   // อิโมจิที่ใช้
      size: 54,     // ขนาด (px)
      x:    null,   // ตำแหน่งแนวนอน % จากซ้าย (null = ตามตำแหน่งฐาน ซ้าย/กลาง/ขวา)
      y:    null,   // ตำแหน่งแนวตั้ง % จากขอบล่าง (null = ระดับขอบพื้นอัตโนมัติ)
    },
