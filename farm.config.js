...
const CONFIG = {
  ...
  // จำนวนคอลัมน์ของกริดตามจำนวนแปลง (ใช้ค่าแรกที่ plotCount <= upTo) — ใช้เมื่อ fieldSingleRow:false
  gridCols: [{upTo: 8, cols: 4}, {upTo: 15, cols: 5}, {upTo: Infinity, cols: 6}],
  fieldSingleRow: true,            // true = แปลงเรียงแถวเดียวยาวพาดหน้าดิน · false = กริดหลายแถวแบบเดิม
  ...
  theme: {
    ...
    cloud: '☁️',                 // อิโมจิเมฆ
    growStages: ['🌱','🌳'],     // [-, ต้นไม้คงที่] · ต้นไม่โต มีแต่ผล (อิโมจิผัก) งอกบนต้น
    pests: ['🐛','🐌'],          // ศัตรูพืช
