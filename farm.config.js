...
const CONFIG = {
  ...
  theme: {
    ...
    // ไอคอนแทนสวนตอน "ซ่อนสวน" (แปลงผักแบบย่อ วางบนพื้นแบบของตกแต่ง)
    miniIcon: {
      em:   '🏡',   // อิโมจิที่ใช้
      size: 100,     // ขนาด (px)
      x:    null,   // ตำแหน่งแนวนอน % จากซ้าย (null = ตามตำแหน่งฟาร์ม ซ้าย/กลาง/ขวา)
      y:    16,   // ตำแหน่งแนวตั้ง % จากขอบล่าง (null = ระดับขอบสนามหญ้าอัตโนมัติ)
    },
    pests: ['🐛','🐌'],          // ศัตรูพืช
